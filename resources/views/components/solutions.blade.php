@php
    $featuredSolutions = [
        [
            'title' => 'SDV Cloud',
            'description' => 'SDV Orchestrator Platform Vehicle Software Update Platform & Digital Vehicle Twin Subscription Management Platform Virtual Workbenches for Simulations and DevOps',
