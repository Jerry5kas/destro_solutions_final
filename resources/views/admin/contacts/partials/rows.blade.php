@forelse($contacts as $contact)
    <div class="content-row" data-contact-row="{{ $contact->id }}" style="padding: 1.25rem 1.5rem; border-bottom: 1px solid #f3f4f6; display: grid; grid-template-columns: 40px 2fr 1.5fr 1fr 120px 100px; gap: 1.5rem; align-items: center; transition: background 0.2s ease;">
        <div>
...
@empty
    <div class="contact-empty-state" style="padding: 3rem; text-align: center; color: #6b7280;">
